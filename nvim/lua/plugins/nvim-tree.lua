...
local on_attach = function(bufnr)
  ...
  vim.keymap.set('n', 'gs', cycle_sort, opts('Change Sort'))
  ...
  vim.keymap.set("n", "gr", api.fs.rename_basename, opts "Rename: Basename")
  vim.keymap.set("n", "gR", api.fs.rename, opts "Rename: Path")
  vim.keymap.set("n", "gf", api.live_filter.start, opts "Filter")
  ...
  vim.keymap.set("n", "<M-r>", api.tree.reload, opts "Refresh")
