...
vim.schedule(function()
  ...
  vim.keymap.set('n', '<M-p>', function() Snacks.picker.files { cwd = vim.fn.expand('%:p:h') } end,
    { silent = true, desc = "Files (lwd)" })
  vim.keymap.set('n', '<c-e>', function() Snacks.picker.buffers() end,
    { silent = true, desc = "Buffers" })
  vim.keymap.set('n', '<space>tf', function() Snacks.picker.grep() end,
    { silent = true, desc = "Live grep" })
  vim.keymap.set('n', '<space>tF', function() Snacks.picker.grep_word() end,
    { silent = true, desc = "Grep cword" })
  vim.keymap.set('n', '<space>to', function() Snacks.picker.recent() end,
    { silent = true, desc = "Recent Files" })
  vim.keymap.set('n', '<space>tq', function() Snacks.picker.qflist() end,
    { silent = true, desc = "Quickfix" })
  vim.keymap.set('n', '<space>tl', function() Snacks.picker.resume() end,
    { silent = true, desc = "Resume" })
  vim.keymap.set('n', '<space>tc', function() Snacks.picker.commands() end,
    { silent = true, desc = "Commands" })
  vim.keymap.set('n', '<space>tC', function() Snacks.picker.command_history() end,
    { silent = true, desc = "Commands History" })
  vim.keymap.set('n', '<space>th', function() Snacks.picker.help() end,
    { silent = true, desc = "Helptags" })
  vim.keymap.set('n', '<space>tH', function() Snacks.picker.highlights() end,
    { silent = true, desc = "Highlights" })
  vim.keymap.set('n', '<space>tm', function() Snacks.picker.marks() end,
    { silent = true, desc = "Marks" })
  vim.keymap.set('n', '<space>tz', function() Snacks.picker.zoxide() end,
    { silent = true, desc = "Zoxide" })
  vim.keymap.set('n', '<space>tt', function() Snacks.picker() end,
    { silent = true, desc = "Tagstack" })
  vim.keymap.set('n', '<space>tr', function() Snacks.picker.registers() end,
    { silent = true, desc = "Registers" })
  vim.keymap.set('n', '<space>tb', function() Snacks.picker.lines() end,
    { silent = true, desc = "Open Buffers lines" })
  vim.keymap.set('n', '<space>ld', function() Snacks.picker.diagnostics() end,
    { silent = true, desc = "Diagnostics" })
  vim.keymap.set('n', 'gR', function() Snacks.picker.lsp_references() end,
    { silent = true, desc = "LSP References" })
  vim.keymap.set('n', '<space>lI', function() Snacks.picker.lsp_implementations() end,
    { silent = true, desc = "LSP Implementations" })
  vim.keymap.set('n', '<space>lw', function() Snacks.picker.lsp_workspace_symbols() end,
    { silent = true, desc = "LSP workspace symbols" })
  vim.keymap.set('n', '<leader>z', function() Snacks.picker.spelling() end,
