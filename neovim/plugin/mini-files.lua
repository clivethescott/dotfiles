...
end, { desc = 'Open Files in cwd' })
vim.keymap.set('n', '<space>fo', function() require 'mini.files'.open() end, { desc = 'Open Files in cwd' })
vim.keymap.set('n', '<space>fO', function() require 'mini.files'.open(vim.api.nvim_buf_get_name(0)) end,
  { desc = 'Select file in explorer' })
vim.keymap.set('n', '<leader>!', function() require 'mini.files'.open(vim.api.nvim_buf_get_name(0)) end,
  { desc = 'Select file in explorer' })
