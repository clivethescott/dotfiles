-- https://github.com/tjdevries/advent-of-nvim/blob/13d4ec68a2a81f27264f3cc73dd7cd8c047aab87/nvim/plugin/floaterminal.lua#L1
-- https://www.youtube.com/watch?v=5PIiKDES_wc&t=197s
local state = {
  floating = {
    buf = -1,
    win = -1,
