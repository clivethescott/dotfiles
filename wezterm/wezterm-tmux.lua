...
local conf = {
  ...
  default_gui_startup_args = { 'connect', 'work' },
}

local tabline = wezterm.plugin.require("https://github.com/michaelbrusegard/tabline.wez")
-- https://github.com/michaelbrusegard/tabline.wez/discussions/3#discussioncomment-10516828
...
conf.colors = {
  tab_bar = {
    background = "#1e1e2e", -- https://catppuccin.com/palette/
  },
}
